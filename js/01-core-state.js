...
lightning:{name:"번개",color:0xffe34a,dash:"전광 대쉬",jump:"뇌전 도약",cards:[c("전격탄","공격",10,.8,13,{}),c("과전류","방어",22,12,0,{speed:3}),c("낙뢰","CC기",34,15,14,{stun:.12}),c("뇌신 강림","궁극기",72,44,46,{stun:.135})]},
...
function makeRoom(c){const maxPlayers=clamp(parseInt($("maxPlayers").value)||2,2,4),maxRounds=clamp(parseInt($("roundCount").value)||8,8,20),mode=$("gameMode").value,room={code:c,host:selfId,maxPlayers,maxRounds,mode,phase:"lobby",round:1,deadline:0,battleFinishAt:0,players:{},logs:[],chat:[],fx:[],endReady:{},returnLobbyAt:0,created:now(),upgradeSeed:0,pendingRound:0,finalStats:null};room.players[selfId]=playerBase(-4,8);return room}
